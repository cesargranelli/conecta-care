...
@Component
public class EventoEmAbertoMapperImpl implements EventoEmAbertoMapper {

    @Override
    public List<EventoResponse> fromEntityData(List<Evento> eventos) {
        if ( eventos == null ) {
            return null;
        }

        List<EventoResponse> list = new ArrayList<EventoResponse>( eventos.size() );
        for ( Evento evento : eventos ) {
            list.add( eventoToEventoResponse( evento ) );
        }
    ...
    protected EventoResponse eventoToEventoResponse(Evento evento) {
        if ( evento == null ) {
            return null;
        }
