...
@RestController
@RequestMapping(path = "planos-saude/{idPlanoSaude}/contatos", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
@RequiredArgsConstructor
public class PlanoSaudeContatoHttp {
