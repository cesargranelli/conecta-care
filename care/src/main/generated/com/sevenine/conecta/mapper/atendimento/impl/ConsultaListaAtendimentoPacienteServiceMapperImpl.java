...
@Component
public class ConsultaListaAtendimentoPacienteServiceMapperImpl implements ConsultaListaAtendimentoPacienteServiceMapper {

    @Override
    public List<AtendimentoResponse> fromEntityDataList(List<Atendimento> atendimentos) {
        if ( atendimentos == null ) {
            return null;
        }

        List<AtendimentoResponse> list = new ArrayList<AtendimentoResponse>( atendimentos.size() );
        for ( Atendimento atendimento : atendimentos ) {
            list.add( atendimentoToAtendimentoResponse( atendimento ) );
        }
    ...
    protected AtendimentoResponse atendimentoToAtendimentoResponse(Atendimento atendimento) {
        if ( atendimento == null ) {
            return null;
        }
