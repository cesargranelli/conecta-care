...
@Component
public class ConsultaListaTratamentoMapperImpl implements ConsultaListaTratamentoMapper {
    ...
    @Override
    public TratamentoResponse fromTratamentoData(Tratamento tratamento) {
        if ( tratamento == null ) {
            return null;
        }
    ...
    @Override
    public List<TratamentoResponse> fromEntityDataList(List<Tratamento> tratamentos) {
        if ( tratamentos == null ) {
            return null;
        }

        List<TratamentoResponse> list = new ArrayList<TratamentoResponse>( tratamentos.size() );
