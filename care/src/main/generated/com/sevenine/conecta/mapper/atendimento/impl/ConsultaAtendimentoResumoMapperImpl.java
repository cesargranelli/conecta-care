...
import com.sevenine.conecta.mapper.atendimento.ConsultaAtendimentoResumoMapper;
...
@Component
public class ConsultaAtendimentoResumoMapperImpl implements ConsultaAtendimentoResumoMapper {

    @Override
    public List<AtendimentoDetalheResponse> fromListEntityData(List<Atendimento> atendimentos) {
        if ( atendimentos == null ) {
            return null;
        }

        List<AtendimentoDetalheResponse> list = new ArrayList<AtendimentoDetalheResponse>( atendimentos.size() );
        for ( Atendimento atendimento : atendimentos ) {
            list.add( atendimentoToAtendimentoDetalheResponse( atendimento ) );
        }
    ...
    protected AtendimentoDetalheResponse atendimentoToAtendimentoDetalheResponse(Atendimento atendimento) {
        if ( atendimento == null ) {
            return null;
        }
