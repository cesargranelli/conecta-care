...
public class SequenceCadastro {
    ...
    public void atualizarContato(SequenceCadastro novoSequenceCadastro) {
        setStatus(novoSequenceCadastro.getStatus());
        setDocumento(novoSequenceCadastro.getDocumento());
        setTipo(novoSequenceCadastro.getTipo());
        setModulo(novoSequenceCadastro.getModulo());
    }
